...
const STYLES: Record<BadgeVariant, string> = {
  ...
  ns:       'bg-purple/10   text-purple  border-purple/25',
...
export const COLI_TYPE_LABELS: Record<string, string> = {
  GUT:      'Gut-Primary Colic',
  NS:       'Nervous System Colic',
  ACOUSTIC: 'Acoustic Colic',
  MIXED:    'Multi-System Colic',
}
...
/* ─── Convenience: ColiTypeBadge ─────────────────────────────── */
export function ColiTypeBadge({
  coliType,
  className,
}: {
  coliType: string
  ...
  return (
    <Badge
      variant={COLI_TYPE_VARIANTS[coliType] ?? 'muted'}
      dot
      className={className}
    >
